...
// Grid layout (64x64 VGA; 3x3 pixels per cell).
...
// Palette indices (0-15). Actual 6-bit colors are set in draw_init().
...
// Color per shape index (O, T, I, J, L, S, Z).
...
// One row uses a 16-bit bitset (supports up to 16 columns).
...
// Minimal runtime helpers (no libc).
